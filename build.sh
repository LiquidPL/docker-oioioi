...
RUNTIME_PACKAGES="python2.7 virtualenv texlive-latex-base texlive-lang-polish texlive-latex-extra texlive-fonts-recommended lighttpd rabbitmq-server libstdc++6:i386 zlib1g:i386"

sudo chown -R oioioi:oioioi /home/oioioi/oioioi
